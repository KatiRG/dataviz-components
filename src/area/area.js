...
this.areaChart = function (svg, settings, data) {
  ...
  var vboxPadding = 50;
  svg.attr("viewBox", "0 0 " + (outerWidth+vboxPadding) + " " + (outerHeight+50)).attr("preserveAspectRatio", "xMidYMid meet").attr("role", "img").attr("aria-label", mergedSettings.altText);
